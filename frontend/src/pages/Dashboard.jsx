    ...
    <div className="min-h-screen space-y-5 bg-slate-100 p-2 sm:space-y-8 sm:p-0 dark:bg-slate-950">
      ...
      <div className="rounded-3xl bg-white p-4 shadow-lg sm:p-8 dark:bg-slate-900">
        ...
        {goals.length === 0 ? (
          ...
          <div className="rounded-2xl border-2 border-dashed border-gray-300 py-12 text-center dark:border-slate-700">
      ...
      {/* Achievement Badges */}
      <div className="rounded-3xl bg-white p-5 shadow-lg sm:p-8 dark:bg-slate-900">
